...
| ドメイン | Pipeline | Blackboard | Dialogue | 判定理由 |
|---------|----------|------------|----------|---------|

## サービスカテゴリ分類

| ドメイン | Process | Master | Integration | Supporting | 判定理由 |
|---------|---------|--------|-------------|------------|---------|
...
**ドメイン分類**
- ドメインタイプ: [Pipeline/Blackboard/Dialogue/Hybrid]
...
| 現行モジュール | 対応ドメイン | 対応コンテキスト | マッピング品質 |
|-------------|------------|----------------|--------------|

### データベース/テーブル単位

| DB/テーブル | 対応ドメイン | 対応エンティティ | 分割候補 |
|-----------|------------|----------------|---------|

### API/機能単位

| 現行API | 対応ドメイン | 対応コンテキスト | 移行優先度 |
|--------|------------|----------------|----------|
...
| トランザクション名 | 関連テーブル | 関連ドメイン | サガ化必要性 |
|-----------------|------------|------------|-------------|

### 分散トランザクション候補

| シナリオ | 関連サービス | サガパターン | 補償アクション |
|---------|------------|------------|--------------|
...
| データ | 現オーナー | 将来オーナー | 他サービスへの提供方式 |
|-------|----------|------------|-------------------|

### 分割が必要なテーブル

| テーブル | 分割先1 | 分割先2 | 分割キー | 移行順序 |
|--------|--------|--------|---------|---------|
